    ...
    public class MaskedAIRevamp : NetworkBehaviour
    {
        ...
        public void FixedUpdate()
        {
            ...
            if (__instance.isEnemyDead)
            {
                ...
                if (fakeObject != null)
                {
                    GameObject.Destroy(fakeObject.gameObject);
                }
            ...
            giftFakeItems(); //runs once after first spawn.
            //giftSelfFakeItem();
            //useFakeItems();
        ...
        public void ItemAnimationSelector(Animator creatureAnimator, EnemyAI __instance)
        {
            ...
            {
                //Plugin.mls.LogError("Holding 2h Basic");
            ...
            {
                //Plugin.mls.LogError("Holding 1h flashlight");
            ...
            {
                //Plugin.mls.LogError("Holding 1h Basic");
            ...
            {
                //Plugin.mls.LogError("Holding 1h shovel");
                creatureAnimator.SetTrigger("HoldLung");
                creatureAnimator.ResetTrigger("HoldOneItem");
                creatureAnimator.ResetTrigger("HoldFlash");
                creatureAnimator.ResetTrigger("HoldShotgun");
            ...
            {
                //Plugin.mls.LogError("Holding 1h shotgun");
            ...
            {
                //Plugin.mls.LogError("Holding nothing");
                creatureAnimator.ResetTrigger("HoldFlash");
                creatureAnimator.ResetTrigger("HoldLung");
                creatureAnimator.ResetTrigger("HoldShotgun");
                creatureAnimator.ResetTrigger("HoldOneItem");
